      ...
      <div style={{ maxWidth: "1200px", width: "100%", padding: "72px 24px" }}>
        ...
        <motion.section {...sectionAnimation} style={{ marginBottom: "120px" }}>
          ...
          >
            ...
            >
              NPTEL Certification in Machine Learning, Deep Learning, Artificial
              Intelligence · Springboard Certification in Data Science, Machine
              Learning, Deep Learning, Artificial Intelligence · Data Analytics
              with Excel
            </p>
          </div>
        </motion.section>
